...
Kaggle 무료 GPU에서 처리 성공률, FAR, TAR과 기준값 변화를 비교한다. 운영 후보는 목표 FAR, TAR 손실, 처리 성공률 Gate를 모두 통과해야 한다. 비공개 데이터셋 준비와 실행 순서는 [`KAGGLE_RUNBOOK.md`](KAGGLE_RUNBOOK.md)를 따른다.
