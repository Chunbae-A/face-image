...
| 8 | [JPEG 조건부 두 모델 결합](experiments/jpeg-conditional-ensemble.md) | JPEG 압축에서만 Xception을 보조로 사용할지 검증 |
| 9 | [점수 보정](experiments/score-calibration.md) | 원점수를 화면용 확률로 바꾸기 위한 검증 |
