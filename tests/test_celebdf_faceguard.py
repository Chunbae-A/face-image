...
class EmbeddingEvaluationTests(unittest.TestCase):
    def test_save_load_roundtrip(self):
        ...
        records[0] = replace(records[0], transform_seconds=0.25)
        with tempfile.TemporaryDirectory() as directory:
        ...
        self.assertAlmostEqual(loaded[0].transform_seconds, 0.25, places=5)
        self.assertEqual(loaded[1].transform_seconds, 0.0)
